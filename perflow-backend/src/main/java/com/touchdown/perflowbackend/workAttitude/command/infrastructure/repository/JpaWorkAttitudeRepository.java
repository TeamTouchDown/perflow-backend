...
public interface JpaWorkAttitudeRepository extends WorkAttitudeTravelCommandRepository, WorkAttributeOvertimeCommandRepository, JpaRepository<Travel, Long> {
